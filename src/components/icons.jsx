// Shared line-icon set (Lucide-style) so the app uses consistent SVG icons
// instead of OS emoji. Inherits color via currentColor; size defaults to 18.
...
export const IconBoard = (p) => (
  <Svg {...p}><rect x="3" y="3" width="6" height="18" rx="1" /><rect x="10" y="3" width="6" height="12" rx="1" /><rect x="17" y="3" width="4" height="16" rx="1" /></Svg>
);
...
export const IconPaperclip = (p) => (
  <Svg {...p}><path d="M21.44 11.05l-9.19 9.19a5 5 0 0 1-7.07-7.07l9.19-9.19a3 3 0 0 1 4.24 4.24l-9.2 9.19a1 1 0 0 1-1.41-1.41l8.49-8.49" /></Svg>
);
